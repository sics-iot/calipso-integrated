...
public class Ping4Tester {

	private static final Logger logger = LoggerFactory.getLogger(Ping4Tester.class);

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		PingClient client = new Ping4Client();
		String ip = "172.30.0.234";
