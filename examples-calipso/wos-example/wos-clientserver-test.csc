...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source EXPORT="discard">[CONTIKI_DIR]/examples-calipso/wos-example/wos-server.c</source>
      <commands EXPORT="discard">make wos-server.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]/examples-calipso/wos-example/wos-server.sky</firmware>
    ...
    <motetype>
      ...
      <description>wos-client</description>
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>68.04412704992497</x>
        <y>23.835837581416143</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
